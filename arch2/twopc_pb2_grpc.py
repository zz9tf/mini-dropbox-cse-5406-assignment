...
class VotePhaseServiceStub(object):
...
def add_VotePhaseServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'twopc.VotePhaseService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('twopc.VotePhaseService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class VotePhaseService(object):
    """Service for Vote Phase
    """
...
class DecisionPhaseServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Decision = channel.unary_unary(
                '/twopc.DecisionPhaseService/Decision',
...
class DecisionPhaseServiceServicer(object):
    """Service for Decision Phase
    """
...
def add_DecisionPhaseServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'twopc.DecisionPhaseService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('twopc.DecisionPhaseService', rpc_method_handlers)


 # This class is part of an EXPERIMENTAL API.
class DecisionPhaseService(object):
    """Service for Decision Phase
    """
